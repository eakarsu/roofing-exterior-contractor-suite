...
const seed: DocumentRecord[] = [
  { id: 'doc-1', name: 'Records Packet', type: 'Records', owner: 'Operations Lead', status: 'In review', updatedAt: '2026-05-24 10:00' },
  { id: 'doc-2', name: 'Workspaces Review Bundle', type: 'Workspaces', owner: 'Operations Lead', status: 'Approval pending', updatedAt: '2026-05-24 11:20' },
  { id: 'doc-3', name: 'Requests Evidence Set', type: 'Requests', owner: 'Governance Lead', status: 'Ready', updatedAt: '2026-05-24 09:35' },
];
