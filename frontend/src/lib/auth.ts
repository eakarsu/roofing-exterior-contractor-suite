export const AUTH_COOKIE = 'roofing_exterior_contractor_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@roofing-exterior-contractor.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@roofing-exterior-contractor.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@roofing-exterior-contractor.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
