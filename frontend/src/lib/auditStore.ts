...
const seedAudit: AuditEntry[] = [
  { id: 'audit-seed-1', at: '2026-05-24 08:15', area: 'Records', action: 'Records queue created' },
  { id: 'audit-seed-2', at: '2026-05-24 09:10', area: 'Workspaces', action: 'Workspaces review assigned' },
