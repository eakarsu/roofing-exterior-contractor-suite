...
PORT="${PORT:-5480}"
DB_NAME="${PGDATABASE:-roofing_exterior_contractor_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Roofing Exterior Contractor Suite"
echo "======================================="
echo
...
echo "Starting roofing exterior contractor suite frontend on http://localhost:$PORT"
echo "Login: admin@roofing-exterior-contractor.local / admin123"
